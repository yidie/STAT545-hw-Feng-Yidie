...
- Plot a graph. From the graph, Asia outperforms other continents because it has the highest max_gdp and a relatively low min_gdp. While Africa has both lowest max_gdp and lowest min_gdp. It shows the same thing as that in the table but from a visual perspective.
```{r}
